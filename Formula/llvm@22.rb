class Llvm < Formula
  ...
  def install
    ...
    # https://github.com/llvm/llvm-project/commit/3dcdb4c
    inreplace "libcxx/src/include/aligned_alloc.h",
          "!defined(__ANDROID__) || __ANDROID_API__ >= 28",
          "defined(__APPLE__) && __ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__ >= 101500"
